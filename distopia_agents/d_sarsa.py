...
class DistopiaSARSA:
    ...
    def __init__(self,env_name='distopia-initial4-v0',in_path=None,out_path=None,terminate_on_fail=False,reconstruct=False,seed=234):
        self.seed = seed
    ...
    def init_model(self, reconstruct=False):
        if self.in_path != None:
            ...
            print("LOADING FROM {}".format(self.in_path))
    ...
    def test(self,weightfile=None):
        if weightfile is not None:
            self.sarsa.load_weights(weightfile)
        # Finally, evaluate our algorithm for 5 episodes.
        self.sarsa.test(self.env, nb_episodes=100, nb_max_start_steps=0, visualize=True)



if __name__ == '__main__':
    d = DistopiaSARSA(reconstruct=True,terminate_on_fail=False, in_path=None,seed=123)
    #lsd.dqn.load_weights('{}/{}.h5'.format(d.out_path,d.ENV_NAME))
    #d.train(episodes=100)
    d.test(weightfile='/home/dev/research/distopia/gym-distopia/distopia-initial4-v0.h5')
